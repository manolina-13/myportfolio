# Manolina Das | Personal Portfolio

Welcome to the source code for my personal portfolio! This is a modern, responsive, and dynamic web application that showcases my academic journey, internships, skills, and featured software engineering projects.
...
1. Clone this repository to your machine:
   ```bash
   git clone https://github.com/manolina-13/myportfolio.git
   ```
2. Open the newly cloned folder:
   ```bash
   cd myportfolio
   ```
3. Simply double-click `index.html` to launch the site instantly in any modern web browser.

---
*Designed and built with passion by Manolina Das.*
